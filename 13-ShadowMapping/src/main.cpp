...
void applicationLoop() {
	...
	while (psi) {
		...
		/*******************************************
		* Se dibuja la escena desde la luz
		Paso1
		*/
		...
		/*******************************************
		* Visualizar el mapa de sombras
		DEBUG
		*/
		// reset ViewPort
	/*	glViewport(0, 0, screenWidth, screenHeight);
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		// Render eñ buffer de profundidad desde la luz en una primitiva cuadrada
...
void prepareScene(){ // IMPORTANTE, se deben colocar sus objetos nuevos
...
void prepareDepthScene(){ //IMPORTANTE, se deben colocar sus objetos nuevos
